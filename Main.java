...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    try {
      while (i < args.length) {
        ...
        // Movement switch.
          ...
          case 'c':
            moveType = TerrainMap.MovementType.Chess;
            break;
          case 'e':
            moveType = TerrainMap.MovementType.Euclidean;
            break;
          case 'm':
            moveType = TerrainMap.MovementType.Manhattan;
            break;
          default:
            throw new IllegalArgumentException("Unrecognized movement type.");
          }
        }
        // Contour switch.
    ...
    for (AIModule ai : aiList) {
      ...
      System.out.println(
          "PathCost, " + cost + ", Uncovered, " + map.getNumVisited() + ", TimeTaken, " + (endTime - startTime));
